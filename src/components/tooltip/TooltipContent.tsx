...
// However, when consuming the Tooltip, it's highly recommended to
...
animate-in
shadow-[inset_0px_0px_0px_1px_var(--radix-tooltip-border-color),0_2px_4px_rgb(0,0,0,0.15)] rounded-md
px-3 py-1.5
